...
const foorterYear = document.querySelector('.year');

window.onload = () => {
    let url = 'https://api.themoviedb.org/3/movie/953?api_key=ea613aebba835baff975b52b37a88ab9';
    ...
    .then(data => {
        ...
        foorterYear.textContent = currentYear;
